...
@Component({
  selector: 'app-managedemandeconge',
  templateUrl: './managedemandeconge.component.html',
  styleUrls: ['./managedemandeconge.component.css',
...
export class ManagedemandecongeComponent implements OnInit {
