...
@Component({
  selector: 'app-manageafectationpost',
  templateUrl: './manageafectationpost.component.html',
  styleUrls: ['./manageafectationpost.component.css',
...
export class ManageafectationpostComponent implements OnInit {
